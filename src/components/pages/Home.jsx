...
function Home({ peliculas, handleFilterMovie, handleFilterYear, years, handleFilterRemove, filterMovie, filteryear }) {
    
    return (
        <>
            <section className='header__filter'>
                <Filter handleFilterMovie={handleFilterMovie} handleFilterYear={handleFilterYear} years={years} handleFilterRemove={handleFilterRemove} filterMovie={filterMovie} filteryear={filteryear}/>
